...
delta = args.delta  # delta parameter for shuffle differential privacy
...
# save results
folder_name = f"results/shuffle_naive_noisy_binary_search/N_{N}/B_exp_{B_exp}/delta_{delta}"
